...
text = ['breast_cancer','obesity', 'wine',  'phishing',  'spam']
dc = [bs.breast_cancer(), bs.obesity(), bs.wine(), bs.phishing(), bs.spam()]
...
dataLR.to_csv('dataLR_evotuned.csv')
dataSVM.to_csv('dataSVM_evotuned.csv')
